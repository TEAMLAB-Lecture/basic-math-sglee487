...
def get_median(number_list):
    ...
    if len(number_list) % 2 == 0:
        median = (sorted_number_list[(len(number_list)-1)//2] + sorted_number_list[((len(number_list)-1)//2) + 1]) / 2
    else:
        median = sorted_number_list[(len(number_list)-1)//2]
    return median
